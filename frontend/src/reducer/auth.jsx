...
export const createUser = createAsyncThunk('auth/createUser', async (payload, { rejectWithValue }) => {
  try {
...
export const login = createAsyncThunk('auth/login', async (payload, { rejectWithValue }) => {
  try {
    const response = await axios.post('http://localhost:3000/api/v1/user/login', payload, { withCredentials: true });
    return response.data;
  } catch (error) {
